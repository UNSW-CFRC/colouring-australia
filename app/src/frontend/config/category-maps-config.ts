    ...
    [Category.Resilience]: [
        {
            ...
            legend: {
                ...
                elements: [
                    { color: '#1a9850', text: '>216' },
                    { color: '#33a35c', text: '204-216' },
                    { color: '#4daf69', text: '192-204' },
                    { color: '#66ba75', text: '180-192' },
                    { color: '#80c681', text: '168-180' },
                    { color: '#99d18e', text: '156-168' },
                    { color: '#b3dd9a', text: '144-156' },
                    { color: '#cce8a6', text: '132-144' },
                    { color: '#e6f4b3', text: '120-132' },
                    { color: '#ffffbf', text: '108-120' },
                    { color: '#fbe8ae', text: '96-108' },
                    { color: '#f6d19d', text: '84-96' },
                    { color: '#f2ba8c', text: '72-84' },
                    { color: '#eda37b', text: '60-72' },
                    { color: '#e98c6b', text: '48-60' },
                    { color: '#e4755a', text: '36-48' },
                    { color: '#e05e49', text: '24-26' },
                    { color: '#db4738', text: '12-24' },
                    { color: '#d73027', text: '<12' },
                ]
                }
        },{
