    ...
    [Category.Resilience]: [
        {
            ...
            legend: {
                ...
                elements: [
                    { color: '#1a9850', text: '>270' },
                    { color: '#33a35c', text: '255-270' },
                    { color: '#4daf69', text: '240-255' },
                    { color: '#66ba75', text: '225-240' },
                    { color: '#80c681', text: '210-225' },
                    { color: '#99d18e', text: '195-210' },
                    { color: '#b3dd9a', text: '180-195' },
                    { color: '#cce8a6', text: '165-180' },
                    { color: '#e6f4b3', text: '150-165' },
                    { color: '#ffffbf', text: '135-150' },
                    { color: '#fbe8ae', text: '120-135' },
                    { color: '#f6d19d', text: '105-120' },
                    { color: '#f2ba8c', text: '90-105' },
                    { color: '#eda37b', text: '75-90' },
                    { color: '#e98c6b', text: '60-75' },
                    { color: '#e4755a', text: '45-60' },
                    { color: '#e05e49', text: '30-45' },
                    { color: '#db4738', text: '15-30' },
                    { color: '#d73027', text: '<15' },
                ]
                }
        },{
